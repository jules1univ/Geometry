...
\begin{itemize}
  \item \textbf{Tutoriel}: A la premi\`ere ouverture de l'application, un tutoriel interactif s'affiche pour vous guider \`a travers les fonctionnalit\'es principales du logiciel. Vous pouvez choisir de suivre le tutoriel ou de le fermer pour explorer l'application par vous-m\^eme.
...
\subsection{Tutoriel}
Lors de la premi\`ere ouverture de l'application, un tutoriel interactif s'affiche pour vous guider \`a travers les fonctionnalit\'es principales du logiciel. Au cours du tutoriel, vous passerez en revue les principales sections de l'interface et les fonctionnalit\'es de base pour vous familiariser avec l'application. Vous pouvez choisir de suivre le tutoriel ou de le fermer pour explorer l'application par vous-m\^eme.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{quickstart_main.png}
  \caption{Tutoriel interactif}
\end{figure}

Si vous choisissez de suivre le tutoriel, vous serez guid\'e \'etape par \'etape comme ici:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{quickstart_step1.png}
  \caption{Tutoriel interactif - Premi\`ere \'etape}
\end{figure}

A tout moment vous pouvez cliquer sur le boutton ``Passer'' pour fermer le tutoriel et acc\'eder directement \`a l'interface principale de l'application.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{quickstart_step2.png}
  \caption{Tutoriel interactif - Deuxi\`eme \'etape}
\end{figure}

Une fois le tutoriel compl\'et\'e, cliquez sur le boutton ``Terminer'' .

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{quickstart_step_end.png}
  \caption{Fin du tutoriel interactif}
\end{figure}
...
Une fois que vous avez ouvert plusieurs tables, le menu ``Fichier'' vous propose de charger directement des tables r\'ecemment ouvertes:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{topbar_menu_file_recent.png}
  \caption{Menu Fichier - Tables r\'ecemment ouvertes}
\end{figure}
...
Vous pouvez configurer les raccourcis clavier pour les actions courantes dans l'application. Cela vous permet d'acc\'eder rapidement \`a ces actions sans avoir \`a naviguer dans les menus. Voici un r\'esum\'e des raccourcis clavier par d\'efaut pour les actions courantes dans Pangol1:
...
Pour modifier un raccourci, cliquer sur un \'element de la liste dans la colonne ``Raccourci''.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{settings_shortcuts_edit.png}
  \caption{Modification d'un raccourci clavier}
\end{figure}

Ensuite composer votre raccourci et valider une fois que vous avez termin\'e.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{settings_shortcuts_done.png}
  \caption{Raccourci clavier modifi\'e}
\end{figure}
...
\begin{itemize}
  ...
  \item \textbf{Fusion}: Permet de fusionner deux tables de donn\'ees en une seule table.
...
S\'election du filtre \`a appliquer, par exemple qui contient une cat\'egorie ou une autre cat\'egorie:
\begin{figure}[H]
  \centering
...
Ensuite ajouter votre filtre aux filtres globaux pour l'appliquer sur la table:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{filter_add.png}
  \caption{Ajout du filtre aux filtres globaux}
\end{figure}
...
\subsubsection*{Fusion de tables}
La fusion de tables permet de combiner les donn\'ees de deux tables en une seule table. Vous pouvez choisir la mani\`ere dont les tables seront fusionn\'ees, par exemple en utilisant une jointure interne (inner join) pour ne conserver que les lignes qui ont des correspondances dans les deux tables, ou une jointure externe (outer join) pour conserver toutes les lignes de l'une ou l'autre table, etc.
Par d\'efaut, la fusion de tables est d\'esactiv\'ee tant que vous n'avez pas au moins deux tables ouvertes:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{table_toolbar_merge_disable.png}
  \caption{Fusion de tables d\'esactiv\'ee}
\end{figure}

Ensuite une fois que vous avez au moins deux tables ouvertes, le boutton de fusion devient actif et vous pouvez cliquer dessus pour ouvrir le menu de fusion de tables:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{table_toolbar_merge.png}
  \caption{Fusion de tables activ\'ee}
\end{figure}

Enfin vous pouvez entrer les param\`etres de votre fusion de tables:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{merge_main.png}
  \caption{Menu de fusion de tables}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{merge_select.png}
  \caption{Sélection du type de jointure}
\end{figure}
...
Les labelles de l'axe X et de l'axe Y sont choisit automatiquement en fonction des colonnes s\'electionn\'ees, mais vous pouvez les modifier manuellement si vous le souhaitez:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{report_chart_setting_auto_label.png}
  \caption{G\'en\'eration automatique des labelles de l'axe X et de l'axe Y}
\end{figure}

Me\^me chose pour le titre du graphique qui est g\'en\'er\'e automatiquement en fonction des colonnes:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{report_chart_setting_auto_title.png}
  \caption{G\'en\'eration automatique du titre du graphique}
\end{figure}
